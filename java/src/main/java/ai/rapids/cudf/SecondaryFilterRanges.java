...
/**
 * Pair of range arrays returned by
 ...
 *   <li>{@link #dictionaryPageRanges()} — where the column-chunk dictionary pages used for
 *       row-group pruning of (in)equality predicates lie.</li>
 * </ul>
 *
 ...
 *
 * <p>Mirrors the
 * {@code std::pair<std::vector<byte_range_info>, std::vector<dictionary_page_range>>}
...
public final class SecondaryFilterRanges {
  ...
  private final DictionaryPageRange[] dictionaryPageRanges;
