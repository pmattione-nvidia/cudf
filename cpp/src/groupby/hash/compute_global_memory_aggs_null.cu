...
compute_global_memory_aggs<nullable_global_set_t<false>>(bitmask_type const* row_bitmask,
...
template std::pair<std::unique_ptr<table>, rmm::device_uvector<size_type>>
compute_global_memory_aggs<nullable_global_set_t<true>>(bitmask_type const* row_bitmask,
                                                        table_view const& values,
